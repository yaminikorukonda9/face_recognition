...
def encode_faces(imagePath, detection_method):
    ...
    try:
        ...
        #Detect the (x, y)-coordinates of bounding boxes for faces in the input image.
...
def process_images():
    ...
    encoding_structure = constants.ENCD_LIST
    ...
    data = {constants.KNOWN_ENCD: known_encodings,
